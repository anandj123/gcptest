...
-Dexec.args="--project=anand-bq-test-2 --stagingLocation=gs://anand-bq-test-2/staging/ \
--output=gs://anand-bq-test-2/output --runner=DataflowRunner \
--region=us-east1 \
--labels='{\"name\":\"test-dataflow-label\",\"environment\":\"development\"}' "


mvn -Pdataflow-runner compile exec:java -Dexec.mainClass=org.apache.beam.examples.WordCount -Dexec.args='--project=anand-bq-test-2 --stagingLocation=gs://anand-bq-test-2/staging/ --output=gs://anand-bq-test-2/output --runner=TestDataflowRunner --region=us-east1 --labels="{name:anand,project:dev}" '
...
public class WordCount {
  ...
  public static void main(String[] args) {
    ...
    //   if (args[i].split("=")[0].equals("--labels")) {
    //     JSONObject jsonObj = new JSONObject(args[5].split("=")[1]);
    //     args[i] = "--labels=" + jsonObj.toString();
    //   }
    // }
